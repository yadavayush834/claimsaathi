...
|    03 | Landing, problem framing, and trust boundary      | Citizen understands the task, independence from EPFO, synthetic-data policy, and can enter the demo without login                                   | IN PR       |
