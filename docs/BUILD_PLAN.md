...
|    12 | OpenAI claim-issue interpreter                          | Unstructured synthetic status text becomes validated structured classification, uncertainty, explanation, and cited next steps; safe fallback works                 | IN PR       |
