...
|    09 | Simplified claim-form journey                           | A citizen completes the required mock application fields with inline validation, saved progress, and no dead ends                                                   | IN PR       |
