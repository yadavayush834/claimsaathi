...
|    04 | Synthetic citizen session and mock service layer  | Versioned demo personas and claims load through typed service boundaries; refresh recovery works                                                    | IN PR       |
