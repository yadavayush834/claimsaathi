...
|    11 | Claim-status timeline                                   | Submitted claims progress through deterministic mock states with readable events, pending actions, and refresh persistence                                          | IN PR       |
